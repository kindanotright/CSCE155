...
int main(int argc, char **argv) {
    ...
    double bethsda[] =          { 68,  37,  24, 0.00, 0.46, 0.65, 0.73}; 
    double bungie [] =          {168, 137, 124, 0.00, 0.18, 0.26, 0.34}; 
    double riot [] =            {163,  47,  64, 0.00, 0.71, 0.61, 0.36}; 
    double epic [] =            {253, 237, 164, 0.00, 0.06, 0.35, 0.01}; 
    double ubisoft [] =         { 56,  23,  16, 0.00, 0.59, 0.71, 0.78}; 
    double rockstar [] =        {152, 137, 135, 0.00, 0.10, 0.11, 0.40}; 
    ...
    const struct CMUnitTest tests[] = {
            ...
            cmocka_unit_test_prestate(testBidirectionalValues, &bethsda),
            cmocka_unit_test_prestate(testBidirectionalValues, &bungie),
            cmocka_unit_test_prestate(testBidirectionalValues, &riot),
            cmocka_unit_test_prestate(testBidirectionalValues, &epic),
            cmocka_unit_test_prestate(testBidirectionalValues, &ubisoft),
            cmocka_unit_test_prestate(testBidirectionalValues, &rockstar)
  };
